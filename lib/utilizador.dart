...
Future<List<Utilizador>> getUtilizadores() async{
  http.Response resposta = await http.get(Uri.encodeFull('http://fef807502b54.ngrok.io/api/Utilizador'), headers:{"Accept" : "application/json"});
...
Future<Utilizador> getUtilizadors(int id) async {
  http.Response response = await http.get(
    Uri.encodeFull("http://fef807502b54.ngrok.io/api/Utilizador" + id.toString()),
    headers: {
...
Future <int> createUtilizador(Utilizador user) async {
  var url = 'http://fef807502b54.ngrok.io/api/Utilizador';
...
{
  var url = "http://b879641b.ngrok.io/api/Login";
