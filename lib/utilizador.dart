...
Future<List<Utilizador>> getUtilizadores() async{
  http.Response resposta = await http.get(Uri.encodeFull('http://431b2308.ngrok.io/api/Utilizador'), headers:{"Accept" : "application/json"});
...
Future<Utilizador> getUtilizadors(int id) async {
  http.Response response = await http.get(
    Uri.encodeFull("http://431b2308.ngrok.io/api/Utilizador" + id.toString()),
    headers: {
...
Future <int> createUtilizador(Utilizador user) async {
  var url = 'http://431b2308.ngrok.io/api/Utilizador';
...
{
  var url = "http://431b2308.ngrok.io/api/Login";
