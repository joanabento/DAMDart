...
Future<List<Utilizador>> getUtilizadores() async{
  http.Response resposta = await http.get(Uri.encodeFull('http://825ce5240a3a.ngrok.io/api/Utilizador'), headers:{"Accept" : "application/json"});
...
Future<Utilizador> getUtilizadors(int id) async {
  http.Response response = await http.get(
    Uri.encodeFull("http://825ce5240a3a.ngrok.io/api/Utilizador/" + id.toString()),
    headers: {
...
Future <int> createUtilizador(Utilizador user) async {
  var url = 'http://825ce5240a3a.ngrok.io/api/Utilizador';
...
Future<int> eliminarUti(int idU) async {
  print(idU);
  var url = 'http://825ce5240a3a.ngrok.io/api/Utilizador/' + idU.toString();
...
{
  var url = "http://825ce5240a3a.ngrok.io/api/Login";
