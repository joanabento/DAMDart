...
Future<List<Administrador>> getAdministradores() async{
  http.Response resposta = await http.get(Uri.encodeFull('http://4cce06a837ab.ngrok.io/api/Administrador'), headers:{"Accept" : "application/json"});
...
Future<Administrador> getAdministradors(int id) async {
  http.Response response = await http.get(
    Uri.encodeFull("http://4cce06a837ab.ngrok.io/api/Administrador" + id.toString()),
    headers: {
...
Future<int> createAdmin(Administrador administrador) async {
  var url = 'http://4cce06a837ab.ngrok.io/api/Administrador';
