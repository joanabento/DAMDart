...
class Produto extends Model{
  ...
  http.Response resposta = await http.get(Uri.encodeFull('http://ab8d68853b54.ngrok.io/api/Produto'), headers:{"Accept" : "application/json"});
  ...
  http.Response response = await http.get(
    Uri.encodeFull("http://ab8d68853b54.ngrok.io/api/Produto" + id.toString()),
    headers: {
...
Future<int> createProduto(Produto p) async {
  var url = 'http://ab8d68853b54.ngrok.io/api/Produto';
