...
class Produto extends Model{
  ...
  http.Response resposta = await http.get(Uri.encodeFull('http://7a687372785c.ngrok.io/api/Produto'), headers:{"Accept" : "application/json"});
  ...
  http.Response response = await http.get(
    Uri.encodeFull("http://7a687372785c.ngrok.io/api/Produto" + id.toString()),
    headers: {
...
Future<int> createProduto(Produto p) async {
  var url = 'http://7a687372785c.ngrok.io/api/Produto';
...
Future<int> EliminarProduto (int idP) async{
  print(idP);
  var url = 'http://7a687372785c.ngrok.io/api/Produto/' + idP.toString();
