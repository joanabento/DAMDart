...
Future<List<Informacao>> getInformacao() async{
  http.Response resposta = await http.get(Uri.encodeFull('http://7a687372785c.ngrok.io/api/Informacao'), headers:{"Accept" : "application/json"});
...
Future<Informacao> getInformacoes(int id) async {
  http.Response response = await http.get(
    Uri.encodeFull("http://7a687372785c.ngrok.io/api/Informacao" + id.toString()),
    headers: {
...
Future <int> createInfo(Informacao informacao) async {
  var url = 'http://7a687372785c.ngrok.io/api/Informacao';
...
Future<int> eliminarInfo (int idInfo) async{
  print(idInfo);
  var url = 'http://7a687372785c.ngrok.io/api/Informacao/' + idInfo.toString();
