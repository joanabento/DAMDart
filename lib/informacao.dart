...
Future<List<Informacao>> getInformacao() async{
  http.Response resposta = await http.get(Uri.encodeFull('http://d379cfa93db3.ngrok.io/api/Informacao'), headers:{"Accept" : "application/json"});
...
Future<Informacao> getInformacoes(int id) async {
  http.Response response = await http.get(
    Uri.encodeFull("http://d379cfa93db3.ngrok.io/api/Informacao" + id.toString()),
    headers: {
...
Future <int> createInfo(Informacao informacao) async {
  var url = 'http://d379cfa93db3.ngrok.io/api/Informacao';
...
void updateInfo(int idInfo, String what, DateTime hora, String nome, int contacto, String descricao) async{
  var url = 'http://d379cfa93db3.ngrok.io/api/Informacao' + idInfo.toString() + "/" + what;
